...
/***
Modification Log:
1.Modified On :18-Apr-2013
Modified By :Ranjitha
Modified Reason: In Mozilla on select of an item, dropdown was getting closed without clicking on ok,to avoid that below code is added
        ...
        init: function (element, options) {
            ...
            if (!$(document).data('editable-handlers-attached')) {
                ...
                $(document).on('click.editable', function (e) {
                    ...
                    //Refernce:https://github.com/vitalets/x-editable/commit/a670211bac7fdb26d4fda22548b10547433e29f2 
                    //Reason : on select dropdown was getting closed in mozilla ,to avoid that below code is added 
                    //Modified By: Ranjitha on 18-Apr-2013
